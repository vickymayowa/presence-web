            ...
            <div className="hidden lg:flex flex-col justify-between p-12 bg-secondary/10 relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-6 max-w-md">
                    <h2 className="text-5xl font-serif leading-[1.1] tracking-tight">
                        Elevate your team's <span className="text-primary italic">management</span> experience.
                    </h2>
                    <p className="text-lg text-muted-foreground font-light leading-relaxed">
                        Join thousands of companies using Presence to streamline attendance,
                        manage leaves, and foster professional growth with biometric security.
                    </p>

                    <div className="flex items-center gap-6 pt-8">
                        <div className="space-y-1">
                            <p className="text-2xl font-serif">10k+</p>
                            <p className="text-xs uppercase tracking-widest text-muted-foreground font-bold">Active Users</p>
                        </div>
                        <div className="w-px h-10 bg-border" />
                        <div className="space-y-1">
                            <p className="text-2xl font-serif">99.9%</p>
                            <p className="text-xs uppercase tracking-widest text-muted-foreground font-bold">Uptime</p>
                        </div>
                    </div>
                </div>
